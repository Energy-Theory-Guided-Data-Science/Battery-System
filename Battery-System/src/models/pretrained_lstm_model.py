...
class Model: 
    ...
    def initialize(self, params):
        ...
        # initialize models
        sequence_autoencoder = tf.keras.Model(inputs, decoded, name='Autoencoder LSTM')
...
#         encoder.summary()
        ...
        # define LSTM
        lstm_layer_1 = layers.LSTM(units=params['n_lstm_units_1'])(lstm_input)
        activation_layer_1 = layers.LeakyReLU(alpha=params['alpha_1'])(lstm_layer_1)
        
#         lstm_layer_2 = layers.LSTM(units=params['n_lstm_units_2'])(lstm_layer_1)
#         activation_layer_2 = layers.LeakyReLU(alpha=params['alpha_2'])(lstm_layer_2)
        
        output_layer = layers.Dense(1, activation=params['activation_output_layer'])(activation_layer_1)

        # initialize & compile model
        model = tf.keras.Model(lstm_input_timeseries, output_layer, name='Pretrained LSTM')
        model.summary()
