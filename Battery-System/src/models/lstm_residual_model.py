...
class Residual_Model: 
    ...
    def test_usecases(self, X_train, y_train, u_train, X_case_1, y_case_1, u_case_1, X_case_2, y_case_2, u_case_2, X_case_3, y_case_3, u_case_3, scalers_train):
        ...
        plt.plot(time_case_1, y_true_case_1_unscaled, color='g', label='measured')
        ...
        plt.plot(time_case_2, y_true_case_2_unscaled, color='g', label='measured')
        ...
        plt.plot(time_case_3, y_true_case_3_unscaled, color='g', label='measured')
